...
export function _compactValue(activeCtx, activeProperty, value) {
      // value is a @value
      if (_isValue(value)) {
        // get context rules
        var type = getContextValue(activeCtx, activeProperty, '@type');
        var language = getContextValue(
